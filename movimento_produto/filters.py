...
class MovimentoProdutoFilter(filters.FilterSet):
	...
	quantidade_entrada_maior_que = filters.DateFilter(field_name='quantidade_entrada', lookup_expr='gt')
	quantidade_saida_maior_que = filters.DateFilter(field_name='quantidade_saida', lookup_expr='gt')
	...
	class Meta:
		...
		fields = [
				'id', 'id_produto', 'id_produto_codigo',
				'quantidade_entrada_maior_que', 'quantidade_saida_maior_que',
